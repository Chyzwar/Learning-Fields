...
public class ConcordAnswers {
	...
	//Add a method to search for one word and print the line numbers where that word occurs
	public void printLineNumbersForWord(String word) {
		
		//Extract Set of values for a given keyword
		TreeSet <Integer> lineNumbers = concordance.get(word);

		//for each entry
		//  get and print the set of integers (the value)
		System.out.print("Lines for " + word + " are ");
		...
		//again using foreach loop instead
		//  get and print the set of integers (the value)
		System.out.print("Lines for " + word + " are ");
	...
	//Add a method to print words only
	public void printWordsOnly() {
		
		//Extract keys only
		Set <String> keys = concordance.keySet();  

		//for each key
		//  get and print the word (the key)
		for (String key: keys){
			//print key and newline
